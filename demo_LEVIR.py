...
def get_args():
    ...
    parser.add_argument('--output_folder', default='outputs/LEVIR', type=str)
    ...
    parser.add_argument('--net_G', default='ChangeFormerV6', type=str,
                        help='ChangeFormerV1 | ChangeFormerV2 | ChangeFormerV3 | ChangeFormerV4 | ChangeFormerV5 | ChangeFormerV6')
